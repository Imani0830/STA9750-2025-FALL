...
`r paste0("District 51 has the most trees, number of trees are ", 70927, ".")`
...
`r paste0("Council District 7 has the highest density of trees. With a tree count of ", 15537, " and density of ", 0.000282, ".")`
...
`r paste0("District 32 has the highest fraction of dead trees. Total tree amount is ", 30261, 
         ", with ", 4304, " dead. That gives a fraction of ", 0.142, " dead.")`
...
`r "The most common tree species in Manhattan is the Gleditsia triacanthos var. inermis - Thornless honeylocust. There are 17,311."`
...
`r "The closest tree to Baruch is the Ginkgo biloba - maidenhair tree."`
...
Quantitative comparison with Districts 9, 12, and 51 shows that our district has lower tree density per square meter but higher public foot traffic and community engagement potential, making it an ideal candidate for expanded tree initiatives (insert bar or dot plot here showing comparison).
