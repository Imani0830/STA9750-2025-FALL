...
`r paste0("District 50 has the most trees, number of trees are ", 2356, ".")`
...
`r paste0("Council District 50 has the highest density of trees. With a tree count of ", 2356, " and density of ", 3.541, ".")`
...
`r paste0("District 15 has the highest fraction of dead trees. Total tree amount is ", 20, 
         ", with ", 10, " dead. That gives a fraction of ", 0.50, " dead.")`
...
`r "The closest tree to Baruch is the Pyrus Calleryana - callery pear."`
